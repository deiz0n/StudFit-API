...
INSERT INTO aluno(id, turno_id, colocacao, nome, email, telefone, cirurgias, patologias, meses_experiencia_musculacao, diagnostico_lesao_joelho, status, ausencias_consecutivas, altura, peso, lista_espera, horario_id) VALUES
    ('00d67ac7-a1e9-4abd-a393-8464b77c0c9e', null, null, 'Example 1', 'user1@example.com','1140028922', 'Não tem', 'Sim', 5, 'Não tem', 0, 2, 155, 54.2, false, '6667a4c1-9bfd-422e-9dbc-602f8d0c8e27'),
    ('8fb21820-05a0-4c32-8b1d-96ade5f586d4', null, null, 'Example 2', 'user2@example.com', '11987654321', 'Sim', 'Não', 12, 'Não tem', 0, 1, 172, 68.5, false, '56e88ae8-6a11-468a-a6fb-08cd2ac07a0b'),
    ('ba7a3453-3edd-46c4-b471-050e58fd1e28', null, null, 'Example 3', 'user3@example.com', '11876543210', 'Não tem', 'Sim', 24, 'Sim', 1, 0, 160, 62.0, false, 'fe2baa3a-59fc-43c7-a5b2-8e3e872471d7'),
    ('67a04b94-ddd2-4a60-8d10-0a8d03861f33', null, null, 'Example 4', 'user4@example.com', '11765432109', 'Não tem', 'Não', 8, 'Sim', 1, 0, 178, 85.3, false, '2f2866be-4738-4602-b1ea-27da45143b6c'),
    ('ab97a243-3717-464a-a6f4-5547966686b8', null, null, 'Example 5', 'user5@example.com', '11654321098', 'Sim', 'Não', 15, 'Não tem', 0, 0, 165, 70.8, false, '1bfac9c7-4652-48bb-b4b7-46983225831b'),
    ('49803705-f05b-47b2-b3f8-7eaf1a98458c', null, null, 'Example 6', 'user6@example.com', '11543210987', 'Não tem', 'Sim', 6, 'Não tem', 0, 3, 182, 90.5, false, '3e291362-6377-43a6-a3a7-bf73918f5120'),
    ('7c18169a-b57f-4047-80d7-c1fb9d1df25b', null, null, 'Example 7', 'user7@example.com', '11432109876', 'Sim', 'Não', 10, 'Não tem', 0, 0, 170, 65.2, false, 'd47d73f0-70db-4cb1-aa1b-243d363b476b'),
    ('d2bc643e-bb7f-48a7-bec8-cad6393a74dd', null, null, 'Example 8', 'user8@example.com', '11321098765', 'Não tem', 'Sim', 20, 'Sim', 1, 3, 175, 77.6, false, 'a780503d-88ff-4541-903f-f033f45f42c2'),
    ('d5d7f70a-85c7-4edb-8c96-f2e019121690', null, null, 'Example 9', 'user9@example.com', '11210987654', 'Sim', 'Não', 18, 'Não tem', 0, 0, 168, 72.4, false, 'd47d73f0-70db-4cb1-aa1b-243d363b476b'),
    ('7ee65990-0033-4767-b372-217557f6b5f4', null, null, 'Example 10', 'user10@example.com', '11109876543', 'Não tem', 'Sim', 7, 'Sim', 0, 0, 180, 80.1, false, 'd47d73f0-70db-4cb1-aa1b-243d363b476b'),
    ('cfe9ac21-473a-4046-bf79-d627b222f200', null, null, 'Example 31', 'user31@example.com','84979615895', 'Não tem', 'Sim', 5, 'Não tem', 0, 1, 155, 54.2, false, 'dc93003f-59b9-4b4c-b8dd-9681a7c6d8a8'),
    ('9df33993-7e5e-470c-b14b-cd4c7463faeb', null, null, 'Example 32', 'user32@example.com', '1198835421', 'Sim', 'Não', 12, 'Não tem', 0, 2, 172, 68.5, false, '0f0fd5be-b0c2-4726-953a-68fe80ffc434'),
    ('e48a756d-6aea-4916-b1d5-837a36d3186f', null, null, 'Example 33', 'user33@example.com', '01927543210', 'Não tem', 'Sim', 24, 'Sim', 1, 4, 160, 62.0, false, '6f160df3-f6d0-4e96-99fd-36c4b0ad23cd'),
    ('bb397bf5-f0c7-437b-9ed0-8342fac27870', null, null, 'Example 34', 'user34@example.com', '88109274536', 'Não tem', 'Não', 8, 'Sim', 1, 2, 178, 85.3, false, '4efea951-827d-4736-b399-668525227873'),
    ('eb718e0f-3404-4708-800a-e02873e22dd0', null, null, 'Example 35', 'user35@example.com', '88992837162', 'Sim', 'Não', 15, 'Não tem', 0, 0, 165, 70.8, false, 'a780503d-88ff-4541-903f-f033f45f42c2'),
    ('10f97bb1-5155-40e6-992e-1605b814843f', null, null, 'Example 36', 'user36@example.com', '88110462729', 'Não tem', 'Sim', 6, 'Não tem', 0, 1, 182, 90.5, false, '3e291362-6377-43a6-a3a7-bf73918f5120'),
    ('8d4017cb-b9a2-4324-976c-27acfeb0c2ad', null, null, 'Example 37', 'user37@example.com', '88471039654', 'Sim', 'Não', 10, 'Não tem', 0, 2, 170, 65.2, false, 'd47d73f0-70db-4cb1-aa1b-243d363b476b'),
    ('c6d7625a-d669-47e9-af37-d44f11614fc9', null, null, 'Example 38', 'user38@example.com', '21847362930', 'Não tem', 'Sim', 20, 'Sim', 1, 3, 175, 77.6, false, 'a780503d-88ff-4541-903f-f033f45f42c2'),
    ('6dadb572-1b0e-4e40-9915-3c4feafac8e0', null, null, 'Example 39', 'user39@example.com', '33210987654', 'Sim', 'Não', 18, 'Não tem', 0, 0, 168, 72.4, false, 'd47d73f0-70db-4cb1-aa1b-243d363b476b'),
    ('68dbf89a-b0f3-4b94-ad94-4d015e8d095b', null, null, 'Example 40', 'user40@example.com', '22109876543', 'Não tem', 'Sim', 7, 'Sim', 0, 0, 180, 80.1, false, 'd47d73f0-70db-4cb1-aa1b-243d363b476b'),
    ('0b3bec3f-5f1c-4a2e-a243-177139138c03', null, 1, 'Example 11', 'user11@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('249c514f-26de-4955-881c-d4077f0db4ad', null, 2, 'Example 12', 'user12@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('d27c532d-b14c-4285-ab21-3ce2001ecad6', null, 3, 'Example 13', 'user13@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('18b044a0-2a52-4cc6-b3be-0ff6ddf00d0f', null, 4, 'Example 14', 'user14@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('a0ede6e2-6749-4e8d-9fbc-a3910f93ea4d', null, 5, 'Example 15', 'user15@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('f71bd358-8270-46f9-b9c7-9413dfca3137', null, 6, 'Example 16', 'user16@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('251e223c-ed70-4ad1-82cd-6e4b2315af7a', null, 7, 'Example 17', 'user17@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('24537481-8eab-46b8-af9a-cfcfd02ba029', null, 8, 'Example 18', 'user18@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('69db9901-e6fe-4b66-9127-f4b6b22583cf', null, 9, 'Example 19', 'user19@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('ae57500f-b412-4a11-99f4-4ec87aa23611', null, 10, 'Example 20', 'user20@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('a3f953fb-90a7-4d65-8d39-5f1c0916d111', null, 11, 'Example 21', 'user21@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('af3d470b-0ad7-4f13-a56a-8ff752b921ff', null, 12, 'Example 22', 'user22@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('9c5a9e02-60f8-4c9c-bdf1-e0c7a6e10341', null, 13, 'Example 23', 'user23@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('0a71e732-9d82-4c5b-97df-2c6e896749f4', null, 14, 'Example 24', 'user24@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('cd69df5f-ec3a-4c1b-bc58-9b1b065e9f1a', null, 15, 'Example 25', 'user25@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('3b4f4f65-7287-4d7b-bf22-1d645b909843', null, 16, 'Example 26', 'user26@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('1c2f6d5b-dc53-482e-b1d4-64c8265c0831', null, 17, 'Example 27', 'user27@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('84f4a34b-8c35-451f-a49c-f88e11844e28', null, 18, 'Example 28', 'user28@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('ae645ff3-5b9d-4898-8a18-f578bdc31634', null, 19, 'Example 29', 'user29@example.com', null, null, null, null, null, null, null, null, null, true, null),
    ('ebc4f5fc-29c3-4c26-a18c-49df9a3f4a53', null, 20, 'Example 30', 'user30@example.com', null, null, null, null, null, null, null, null, null, true, null);
